...
def _():
    ...
    ATHENA_URL = sqlalchemy.URL.create(
    ...
    engine = sqlalchemy.create_engine(ATHENA_URL)
    ...
    database_connection_string = (
        f"{connection_status}\n"
        f"Database: {ATHENA_URL.database}\n"
        f"Region: {ATHENA_URL.query['region_name']}\n"
        f"Catalog: {ATHENA_URL.query['catalog_name']}\n"
        f"Workgroup: {ATHENA_URL.query['work_group']}"
    )
